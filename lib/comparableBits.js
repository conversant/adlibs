...
/**
 * @desc Creates the action object with it's attributed bitmask flag
 * @static
...
/**
 * @desc Encapsulates a bitmask service which takes a bitmask and compares it to the attributed action's flag
 * @static
