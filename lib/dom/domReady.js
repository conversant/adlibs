 ...
 * @param {window} [targetWindow] Optionally, you can provide your own window reference for cases where you'd have an iframe.
 * @param {Boolean} [isInteractiveOk] Optionally, interactive mode can be checked for faster responses.
 * @example
 * ```js
