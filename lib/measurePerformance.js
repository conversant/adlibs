...
var MeasurePerformance = function () {
	...
	var safeTimingEvents = function (time, perfObj, minifyTimes) {
		...
		// Even though the nav events dont have times, this is still a valuable indicator of support,
...
//			if (startTime === -1) { return [-1]; }
	...
	/**
	 * Get the timestamp for right now according to the best supported timing info avail (w.performance.now or Date.getTime)
	 * @private
	 * @returns {number}
	 */
	self.now = function () {
